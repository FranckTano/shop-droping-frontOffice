        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <p-card header="Répartition par Bailleur">
            <div class="h-80">
              <p-chart 
                type="doughnut" 
                [data]="repartitionBailleurData" 
                [options]="repartitionBailleurOptions">
              </p-chart>
            </div>
          </p-card>
          ...
          <p-card header="Évolution des Financements">
            <div class="h-80">
              <p-chart 
                type="line" 
                [data]="evolutionFinancementsData" 
                [options]="evolutionFinancementsOptions">
              </p-chart>
            </div>
          </p-card>
        </div>
                  ...
                  <tr *ngFor="let projet of stats.topProjetsParBudget">
                    ...
                    <td class="px-4 py-3">
                      <div class="flex items-center">
                        <p-progressBar 
                          [value]="projet.tauxDecaissement" 
                          [style]="{'width': '100px', 'height': '8px'}"
                          [color]="getProgressColor(projet.tauxDecaissement)">
                        </p-progressBar>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr *ngFor="let bailleur of stats.topBailleursParContribution">
                    ...
                    <td class="px-4 py-3">
                      <div class="flex items-center">
                        <p-progressBar 
                          [value]="bailleur.tauxGlobalDecaissement" 
                          [style]="{'width': '100px', 'height': '8px'}"
                          [color]="getProgressColor(bailleur.tauxGlobalDecaissement)">
                        </p-progressBar>
...
export class FinancementDashboardComponent implements OnInit, OnDestroy {
  ...
  loadMockData(): void {
    ...
    this.financementService.getFinancementStats()
